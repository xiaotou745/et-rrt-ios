...
@implementation TDListUnPassView
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:TaskDListVC_toTaskDetail object:@{@"task":task,@"index":@(2)}];
}
#pragma mark 请求数据
- (void)post{
    //    [MBProgressHUD showHUDAddedTo:self animated:YES];
