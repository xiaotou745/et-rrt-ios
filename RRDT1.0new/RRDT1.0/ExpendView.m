...
- (instancetype)init
{
    self = [super initWithFrame:CGRectMake(WIDTH, 10, WIDTH, HEIGHT - 64 - 40) style:UITableViewStylePlain];
    if (self) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    static NSString *idenifier = @"BillDetailCell";
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:notify_selectBillDetailCell object:@{@"model":model,@"isInComeCell":@(NO)}];
