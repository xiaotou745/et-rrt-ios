...
@implementation TDListPassView

- (instancetype)init
{
    self = [super initWithFrame:CGRectMake(WIDTH, 0, WIDTH, HEIGHT - 64 - 40) style:UITableViewStyleGrouped];
    if (self) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:TaskDListVC_toTaskDetail object:@{@"task":task,@"index":@(1)}];
}
#pragma mark 请求数据
- (void)post{
    //    [MBProgressHUD showHUDAddedTo:self animated:YES];
